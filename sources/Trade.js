...
class Trade {
    ...
    trade(cite)
    {
        ...
        if  (Math.random() > 0.5 && cite[index_cite_0].nbTrader > 0 && cite[index_cite_1].nbTrader > 0 && cite[index_cite_0].gold > cornPrice && cite[index_cite_1].corn > 0)
        {
            ...
            console.log(cite[index_cite_0].name+" buy corn to "+cite[index_cite_1].name+"\n");
        ...
        {
            console.log("Warning : There is an attack **** Trader from the city : " +cite[index_cite_0].name + "is dead.");
