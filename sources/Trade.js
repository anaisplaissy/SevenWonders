...
class Trade
{
    ...
    trade(cite)
    {
        var cites = this.cityChoice(cite)
        var index_cite_0 = cites[0];
        var index_cite_1 = cites[1];

        const maxCorn = cite[index_cite_1].gold;
        const minCorn = 0;
        const cornQuantity = Math.floor(Math.random()*(maxCorn - minCorn) + minCorn);
        const cornPrice = cornQuantity*0.5;

        if  (Math.random() > 0.5 && cite[index_cite_0].nbTrader > 0 && cite[index_cite_1].nbTrader > 0 && cite[index_cite_0].gold > cornPrice && cite[index_cite_1].corn > 0 && cite[index_cite_1].corn > cornQuantity)
        {
            console.log("\n*************** TRADE IN PROGRESS ***************\n ");

            console.log(cite[index_cite_0].name+" posseses " + cite[index_cite_0].corn+" corns and "+cite[index_cite_0].gold + " golds");
            console.log(cite[index_cite_1].name+" posseses " + cite[index_cite_1].corn+" corns and "+cite[index_cite_1].gold + " golds\n");

            console.log("===> " +cite[index_cite_0].name+" buy "+ cornQuantity + " corns to "+cite[index_cite_1].name+" for "+cornPrice+" golds "+"\n");
        ...
        {
            console.log("\n***************** TRADER ATTACK *****************\n ");
            console.log("An attack occurred \nA trader from " +cite[index_cite_0].name + " is dead");
            console.log("\n*************************************************\n ");
